  ...
  const applyJobHandler = async () => {
      try {
        ...
        if(res.data.success){
          ...
          dispatch(setSingleJob(updatedSingleJob)) // this helps to update real time UI update
    ...
    <div className='max-w-7xl mx-auto my-10'>
      ...
      <div>
        ...
        <Button
            ...
            disabled={isApplied} 
            className={`rounded-lg ${isApplied ? 'bg-gray-600 cursor-not-allowed' : 'bg-[#7209b7] hover:bg-[#310779]'}`}>
